$Title  final project arrangement_add_goldtime_ticketprice
$Ontext
...
$Offtext
  ...
  Table price(k,j)  ticket price of film j at different timeslot k in cases
      ...
      night        79.00    59.00    74.00    39.00    59.00    36.00
  ...
  Model arrangement_add_goldtime_ticketprice /all/ ;
...
rhsrng all
$offecho
  arrangement_add_goldtime_ticketprice.OptFile=1;

  solve arrangement_add_goldtime_ticketprice maximizing z using mip;
